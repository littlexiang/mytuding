...
<div class="photo-detail-wrapper">\
    ...
    <div class="photo-title"><p>{{&title}}&nbsp;{{#each tag_new}}<a href="#">#{{this}}</a> &nbsp;{{/each}}</p></div>\
    <div class="photo-ops clearfix">\
        ...
        <a href="#"><span class="glyphicon glyphicon-retweet"></span> {{comment_count}}</a>\
    </div>\
</div>\
{{/list}}',
    pageIndex: '\
    <div id="page-index">\
        <div id="page-index-loading" class="progress progress-striped active" style="margin:1em auto;width:60%;">\
